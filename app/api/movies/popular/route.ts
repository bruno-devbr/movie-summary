...
// Função que lida com requisições GET para filmes populares
export async function GET(req: NextRequest) {
    try {
        ...
        // Faz a requisição para buscar filmes populares, usando idioma e região do Brasil
        const rawData = await api.moviePopular({
            language: "pt-BR",
            region: "BR",
            page,
        });
